...
export const DEFAULT_GENDER_TITLE_CONFIG: GenderTitleConfig = {
    master: Gender.male,
    miss: Gender.female,
    mr: Gender.male,
    mrs: Gender.female,
...
export const DEFAULT_GENDER_NAME_CONFIG: GenderNameConfig = {
    oliver: Gender.male,
    jack: Gender.male,
    harry: Gender.male,
    george: Gender.male,
...
export const DEFAULT_GENDER_CONFIG: GenderConfig = {
    titles: DEFAULT_GENDER_TITLE_CONFIG,
    names: DEFAULT_GENDER_TITLE_CONFIG
}
...
export const DEFAULT_CONFIG: ClubConfig = {
    gender: DEFAULT_GENDER_CONFIG,
    season: DEFAULT_SEASON_CONFIG,
    agegroup: DEFAULT_AGE_GRADE_CONFIG
}